                ...
                <div className='w-full md:w-1/3 bg-white shadow rounded-lg p-6'>
                    ...
                    <div className='space-y-4'>
                        ...
                        <div>
                            ...
                            <input type='date' name="start-date" id="start-date" className={classNames.selectInput} onChange={(e) => setStartDate(e.target.value)} />
                        </div>

                        {/* END DATE */}
                        <div>
                            <label htmlFor="end-date" className={classNames.label}>End Date</label>
                            <input type='date' name="end-date" id="end-date" className={classNames.selectInput} onChange={(e) => setEndDate(e.target.value)} />
                        </div>
                    </div>
                </div>
